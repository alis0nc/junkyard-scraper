...
driver.get('https://usautosupplymi.com/upull/sterling-heights/sterling-heights-inventory/')
...
# Show 100 items
vehicles_length = driver.find_element(By.NAME, 'vehicles_length')
...
while True:
    next_button = driver.find_element(By.ID, 'vehicles_next')
    # Parse the table
    vehicles_table_body = driver.find_element(By.ID, 'vehicles').find_element(By.TAG_NAME, 'tbody')
